...
function iniciarOuPausar() {
    if(intervaloId && tarefaSelecionada !== null){
...
document.addEventListener("TarefaAtiva", () => {
    if(intervaloId){
        startPauseBtIcon.setAttribute("src", "./imagens/play_arrow.png");
        pause.play();
        zerar(); // Para o setInterval
        startPauseBtText.textContent = "Começar"; // Reseta o texto do botão
    }
})
...
removerTodasBt.addEventListener("click", () => {
    localStorage.removeItem("tarefas", listaTarefas)
    alert("Tarefas removidas com sucesso")
})

removerConcluidasBt.addEventListener("click", () => {
    localStorage.removeItem("tarefas", listaTarefas.tarefa.completa) alert("Tarefas removidas com sucesso")
    } else{
        alert("Não há tarefas concluídas a serem removidas")
    }
